  ...
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-300 focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0',
  {
    variants: {
      variant: {
        ...
        primary:
          'bg-[var(--color-accent)] text-white font-semibold hover:bg-[var(--color-accent-hover)] shadow-[0_0_24px_var(--color-accent-glow)] hover:shadow-[0_0_32px_var(--color-accent-glow)]',
        ghost:
        ...
        gradient:
          'bg-gradient-to-r from-[var(--color-accent)] to-[var(--color-accent-warm)] text-white font-semibold hover:shadow-[0_0_32px_hsla(172,70%,42%,0.3)] transition-shadow',
      },
      size: {
